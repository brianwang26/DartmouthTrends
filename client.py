...
from Queries.Query_Processor import recentTerms, allTerms, get_query_result
...
get_query_result(False, True, departmentsOfInterest, recentTerms, True, False, "sample")